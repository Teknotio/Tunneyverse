...
class CleanedRecordingWidget extends StatefulWidget {
  const CleanedRecordingWidget({super.key});

  @override
  State<CleanedRecordingWidget> createState() => _CleanedRecordingWidgetState();
}

class _CleanedRecordingWidgetState extends State<CleanedRecordingWidget> {
