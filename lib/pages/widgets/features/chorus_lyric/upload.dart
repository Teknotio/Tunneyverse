// Unified cross-platform widget for Chorus and Lyric Video Upload
...
class ChorusLyricVideoUpload extends StatefulWidget {
  const ChorusLyricVideoUpload({super.key});

  @override
  State<ChorusLyricVideoUpload> createState() => _ChorusLyricVideoUploadState();
}

class _ChorusLyricVideoUploadState extends State<ChorusLyricVideoUpload> {
  String? pickedFileName;
  DropzoneViewController? dropzoneController;
  String selectedOption = 'Chorus and Lyric Video';
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Text(
                // swapped text
                'AI vocal remover that keeps chorus and generates lyric videos, perfect for karaoke and content creation.',
