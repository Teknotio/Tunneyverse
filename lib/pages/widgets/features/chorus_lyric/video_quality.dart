...
class ChorusVideoQualityWidget extends StatefulWidget {
  const ChorusVideoQualityWidget({super.key});

  @override
  State<ChorusVideoQualityWidget> createState() => _ChorusVideoQualityWidgetState();
}

class _ChorusVideoQualityWidgetState extends State<ChorusVideoQualityWidget> {
