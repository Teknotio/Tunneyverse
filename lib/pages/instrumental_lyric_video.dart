...
import 'package:tuneyverse/pages/widgets/features/instrumental_lyric/video_quality.dart';
...
class InstrumentalAndLyricVideo extends StatelessWidget {
  const InstrumentalAndLyricVideo({super.key});
...
void main() {
  runApp(const MaterialApp(
    ...
    home: InstrumentalAndLyricVideo(),
  ));
}